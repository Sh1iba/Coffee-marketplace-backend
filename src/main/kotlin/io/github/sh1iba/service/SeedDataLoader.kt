...
class SeedDataLoader(
    ...
    private fun seedProducts(sellers: Map<String, Seller>, imgs: Map<String, String>) {
        ...
        val products = listOf(
            ...
            ProductSeed("Специи",   "Масала Чай",             "Традиционный индийский чай с молоком, кардамоном, корицей и имбирём.",                     "spiceroute/Масала_Чай", "Spice Route", listOf(Triple("S",199.0,"250 мл"), Triple("M",249.0,"350 мл"), Triple("L",299.0,"450 мл"))),
            ProductSeed("Специи",   "Куркума Латте",           "Согревающий напиток на основе куркумы с молоком и чёрным перцем. Золотое молоко.",         "spiceroute/Куркума_Латте", "Spice Route", listOf(Triple("S",219.0,"250 мл"), Triple("M",269.0,"350 мл"), Triple("L",319.0,"450 мл"))),
            ProductSeed("Специи",   "Матча Латте",             "Японский зелёный чай маття с молоком и нотками ванили — энергия без кофеиновых скачков.",  "spiceroute/Матча_Латте", "Spice Route", listOf(Triple("S",229.0,"250 мл"), Triple("M",279.0,"350 мл"), Triple("L",329.0,"450 мл"))),
            ProductSeed("Специи",   "Чай Карк",                "Традиционный эмиратский чай с кардамоном, шафраном и розовой водой.",                      "spiceroute/Чай_Карк", "Spice Route", listOf(Triple("S",189.0,"250 мл"), Triple("M",239.0,"350 мл"), Triple("L",289.0,"450 мл"))),
